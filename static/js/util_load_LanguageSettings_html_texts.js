import {load_other_page_text_contents} from './intel_irris_language_setting.js';
...
export async function load_html_texts_for_current_language(passed_page){
    ...
    switch (for_page){
        case 'intel_irris_language_setting_page':
            load_other_page_text_contents();
            break;
        default:
            break;
    }
...
function set_title(){
    switch (for_page){
        case 'intel_irris_language_setting_page':
            document.title = webui_texts['intel_irris_language_setting_page']['title'];
            break;
        default:
...
function set_h1(){
    switch (for_page){
        case 'intel_irris_language_setting_page':
            document.getElementById('h1').innerHTML = webui_texts['intel_irris_language_setting_page']['h1'];
            break;
        default:
            //console.log("[util] cannot set HTML texts for the page!!")
    }
